...
const Register = () => {
    ...
    return (
        <div style={{ backgroundColor: 'black', color: "white", width: 400, margin: '100px auto', padding: 50, borderRadius: 10 }}>
            <h1>Sign Up</h1>
            <form onSubmit={formik.handleSubmit}>
              ...
              Female
                    ...
                    <div>
                        ...
                        <input type="submit" value="Submit" style={{padding:"10px 20px",border:"none" ,color:"white",backgroundColor:"green",borderRadius:5}} />
                    </div>
                </>
            </form>
        </div>
